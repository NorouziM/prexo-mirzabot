...
<code>$subscriptionurl</code>";
    ...
    $textextend = sprintf($textbotlang['hardcoded']['renewInvoiceCreated'], $product['name_product'], $product['Service_time'], $product['Volume_constraint'], $pricelastextend, $user['Balance']) . renewVolumeNote($marzban_list_get['Methodextend']);
    if ($user['step'] == "getvolumecustomuserforextend") {
    ...
    $textextend = sprintf($textbotlang['hardcoded']['renewInvoiceCreated2'], $info_product['name_product'], $info_product['Service_time'], $info_product['Volume_constraint'], $info_product['price_product'], $user['Balance']) . renewVolumeNote($marzban_list_get['Methodextend']);
    $keyboardextend = json_encode([
        'inline_keyboard' => [
            [
